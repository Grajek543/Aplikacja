...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PARTPICKER.Platforms.Android.LightSensorService, PARTPICKER", LightSensorService.class, __md_methods);
	}
	...
	public LightSensorService ()
	{
		...
		if (getClass () == LightSensorService.class) {
			mono.android.TypeManager.Activate ("PARTPICKER.Platforms.Android.LightSensorService, PARTPICKER", "", this, new java.lang.Object[] {  });
		}
	}
