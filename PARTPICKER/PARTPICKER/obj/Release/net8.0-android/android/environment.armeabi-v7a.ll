...
@dso_cache = dso_local local_unnamed_addr global [906 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 80379448, ; hash 0x4ca7e38, from name: PARTPICKER.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1651205817, ; hash 0x626b66b9, from name: aot-PARTPICKER
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PARTPICKER.dll.so
		ptr null; void* handle (0x0)
	}, ; 337
	...
	%struct.DSOCacheEntry {
		i64 2124741387, ; hash 0x7ea4fb0b, from name: aot-PARTPICKER.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PARTPICKER.dll.so
		ptr null; void* handle (0x0)
	}, ; 439
	...
	%struct.DSOCacheEntry {
		i64 2412720670, ; hash 0x8fcf321e, from name: libaot-PARTPICKER
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PARTPICKER.dll.so
		ptr null; void* handle (0x0)
	}, ; 505
	...
	%struct.DSOCacheEntry {
		i64 3122689689, ; hash 0xba207699, from name: PARTPICKER
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PARTPICKER.dll.so
		ptr null; void* handle (0x0)
	}, ; 674
	...
	%struct.DSOCacheEntry {
		i64 3189295719, ; hash 0xbe18ca67, from name: libaot-PARTPICKER.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PARTPICKER.dll.so
		ptr null; void* handle (0x0)
	}, ; 686
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [181 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
